...
!!! abstract "یادداشت مترجم"
	...
	منظور از ویرایشگر آنلاین، محیطی از وبسایت رسمی Elm است که در آن می‌توانید برنامه‌‌های مختلف را مشاهده، ویرایش و کامپایل کنید. علاوه بر این محیط، جامعه کاربری ابزار دیگری برای اشتراک‌گذاری کد و پروژه در نظر گرفته است که با نام Ellie شناخته می‌شود. برای آشنایی بیشتر با این ابزارها، به منابع زیر مراجعه کنید:
