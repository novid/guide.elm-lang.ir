...
تمام مثال‌های این صفحه را می‌توانید در [Elm REPL][elm-repl] وارد کنید. عبارت `2 + 2` را تایپ کنید و کلید ENTER را فشار دهید. باید `4` چاپ شود. باید بتوانید با هر یک از مثال‌های این صفحه به همین روش تعامل داشته باشید!
