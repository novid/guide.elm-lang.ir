...
> **توجه:** درباره عملگرهایی مانند [`(+)`][addition]، [`(/)`][division] و [`(++)`][append]در مستندات ماژول [`Basics`][basics] می‌توانید اطلاعات بیشتری کسب کنید. در یک مقطع، خواندن تمام مستندات آن بسته ارزشمند است!
...
> **توجه:** افرادی که از زبان‌هایی مانند جاوااسکریپت می‌آیند ممکن است تعجب کنند که چرا توابع در اینجا متفاوت به نظر می‌رسند:
>
