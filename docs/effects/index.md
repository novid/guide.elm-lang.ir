...
در نمونه‌های آتی، از [`Browser.element`][browser.element]{: .external } برای ایجاد برنامه استفاده خواهیم کرد. این کار، مفاهیم **دستور** و **اشتراک** را معرفی می‌کند که به ما اجازه می‌دهند با دنیای بیرون تعامل داشته باشیم.
