---
title: Maybe
description: مروری بر مفهوم فراخوانی جزیی، فیلدهای اختیاری و اجتناب از استفاده بیش از حد
...
## فراخوانی جزیی توابع {#partial-functions}
