...
این‌جاست که نوع داده [`Result`][Result] بکار می‌آید. این نوع، به صورت زیر تعریف شده است:
...
هدف از این نوع داده، ارایه اطلاعات اضافی در زمان بروز خطا است. این حالت، برای گزارش و بازیابی خطا بسیار مفید است!
