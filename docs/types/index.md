...
!!! abstract "یادداشت مترجم"
	...
	به منظور مشاهده نوع داده برای هر مقدار یا تابع، پس از باز کردن Elm REPL، اقدام به نوشتن آن مقدار یا تابع کرده و کلید Enter را فشار دهید. در ادامه، نوع داده مقدار یا نشانه‌گذاری نوع داده تابع به شما نمایش داده می‌شود. برای نمونه:
