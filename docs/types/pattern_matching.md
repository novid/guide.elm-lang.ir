...
!!! abstract "یادداشت مترجم"
	...
	با استفاده از نوع داده سفارشی و تطبیق الگو، می‌توانید پیچیده‌ترین حالت‌های ممکن یک وبسایت، وب اپلیکیشن یا بازی را مدل‌سازی کنید. در دنیای برنامه‌نویسی تابعی، این الگو با نام **Make Impossible States Impossible** شناخته می‌شود. برای آشنایی بیشتر با این الگو، به منابع زیر مراجعه کنید:
